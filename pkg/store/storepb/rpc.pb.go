...
type SeriesRequest struct {
	...
	// server supports it.
	WithoutReplicaLabels []string `protobuf:"bytes,15,rep,name=without_replica_labels,json=withoutReplicaLabels,proto3" json:"without_replica_labels,omitempty"`
	// maximum_string_slots is the number of maximum strings
	// that the receiver can send. It is safe to ignore this by
	// the receiver if it does not intend on sending a symbol table
	// via hints later on.
	MaximumStringSlots uint64 `protobuf:"varint,14,opt,name=maximum_string_slots,json=maximumStringSlots,proto3" json:"maximum_string_slots,omitempty"`
}
...
type SeriesResponse struct {
	...
	//	*SeriesResponse_CompressedSeries
...
type SeriesResponse_CompressedSeries struct {
	CompressedSeries *CompressedSeries `protobuf:"bytes,4,opt,name=compressed_series,json=compressedSeries,proto3,oneof" json:"compressed_series,omitempty"`
}
...
func (*SeriesResponse_CompressedSeries) isSeriesResponse_Result() {}
...
func (m *SeriesResponse) GetCompressedSeries() *CompressedSeries {
	if x, ok := m.GetResult().(*SeriesResponse_CompressedSeries); ok {
		return x.CompressedSeries
	}
	return nil
}
...
func (*SeriesResponse) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*SeriesResponse_CompressedSeries)(nil),
	}
}
...
var fileDescriptor_a938d55a388af629 = []byte{
	...
	,
}
...
func (m *SeriesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MaximumStringSlots != 0 {
		i = encodeVarintRpc(dAtA, i, uint64(m.MaximumStringSlots))
		i--
		dAtA[i] = 0x70
	}
	if m.ShardInfo != nil {
...
func (m *SeriesResponse_CompressedSeries) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SeriesResponse_CompressedSeries) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CompressedSeries != nil {
		{
			size, err := m.CompressedSeries.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SeriesRequest) Size() (n int) {
	...
	if m.MaximumStringSlots != 0 {
		n += 1 + sovRpc(uint64(m.MaximumStringSlots))
	}
	if len(m.WithoutReplicaLabels) > 0 {
...
func (m *SeriesResponse_CompressedSeries) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SeriesRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaximumStringSlots", wireType)
			}
			m.MaximumStringSlots = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowRpc
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaximumStringSlots |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *SeriesResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompressedSeries", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Result = &SeriesResponse_CompressedSeries{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipRpc(dAtA[iNdEx:])
